...
class TrainingPackageManifestTests(TestCase):
    def _fixture(self, root: Path) -> Path:
        ...
        files = {
            ...
            "data/splits/seed_42_baseline/train.csv": "image_path,label,environment\n",
            "data/splits/seed_42_baseline/val.csv": "image_path,label,environment\n",
            "data/splits/seed_42_baseline/test.csv": "image_path,label,environment\n",
