...
Mueve y renombra las imagenes en:
    data/clean/lethal_necrosis/Maize Lethal Necrosis Disease/  (busqueda recursiva)
hacia:
    data/clean/lethal_necrosis/real/
con el patron:
    lethal_necrosis_maize_africa_real_<randomNumber>.<ext>
"""
...
BASE_DIR = get_dataset_root() / "clean" / "lethal_necrosis"
SOURCE_DIR = BASE_DIR / "Maize Lethal Necrosis Disease"
DEST_DIR = BASE_DIR / "real"

RANDOM_DIGITS = 8
PREFIX = "lethal_necrosis_maize_africa_real_"
